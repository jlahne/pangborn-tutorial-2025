...
* The `R` packages:
  ...
  + **patchwork**
  + **wesanderson**
* The tutorial materials from our [GitHub](https://github.com/jlahne/pangborn-r-tutorial-2025/). You can download the data we'll use [here now](https://github.com/jlahne/pangborn-r-tutorial-2025/blob/main/code/pangborn-2025-code-download.zip), and the code files will be finalized about a week before the conference.
...
Download the pre-made archive of data from the [workshop github repo](https://github.com/jlahne/pangborn-r-tutorial-2025/blob/main/code/pangborn-2025-code-download.zip) now.
...
You will get a copy of all the code that we will explain during the workshop, but this is considered an intermediate `R` workshop and we will not be spending time on basic `R` skills, programming or statistical theory, or navigating RStudio.We expect participants to have basic familiarity with data types, variables, functions, and installing/using packages in R/RStudio. It will also be helpful to know:
...
```{r function-arguments, echo=FALSE}
question("What does the R console return when you run the above code?",
         answer("1"),
         answer("2"),
         answer("3"),
...
```{r data-frames-matrices, echo=FALSE}
question("What does the R console return when you run the above code?",
         answer("1"),
         answer("2"),
         answer("3"),
...
```{r pipes, echo=FALSE}
question("Rewrite the code `` without pipes.",
         answer("1"),
         answer("2"),
         answer("3"),
         answer("4", correct = TRUE),
